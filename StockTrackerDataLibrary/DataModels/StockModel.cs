...
namespace StockTrackerDataLibrary.DataModels
{
    public class StockModel :IBasicStock  
    {
        ...
        {           
            public decimal Current(StockModel st)
            {
                List<ValuationModel> vals = GlobalConfig.Connection.Valuation_Stock(st._stockId);
            ...
            public List<ValuationModel> HistoryAll(StockModel st)
            {
                return GlobalConfig.Connection.Valuation_Stock(st.StockId);
            }
        }
    }
